  ...
  useEffect(() => {
    const fetchTasks = async () => {
      try {
        ...
        toast.success("Past tasks fetched successfully", {
                    ...
                    completedTasks.map((task) => (
                      <tr key={task._id} className="hover:bg-gray-50">
                        <td className="px-4 py-4 whitespace-nowrap text-sm font-medium text-gray-900">
                          <div className="font-medium">{task.category?.categoryName || "N/A"}</div>
                          <div className="text-xs text-gray-500 mt-1">ID: {task._id.substring(0, 8)}...</div>
                        </td>
                        <td className="px-4 py-4 whitespace-nowrap text-sm text-gray-500">
                          ₹{task.category?.price || "N/A"}
                        </td>
                        <td className="px-4 py-4 whitespace-nowrap text-sm text-gray-500">
                          {task.worker?.firstName || "N/A"} {task.worker?.lastName || ""}
                        </td>
                        <td className="px-4 py-4 whitespace-nowrap text-sm text-gray-500">
